...
$cyber_dc_boot_theme_options = cyber_dc_boot_theme_options();
		/* Do not display sidebars if full width option selected on single
		   post/page templates */
		if ( is_cyber_dc_boot_full_width() ) {
			if ( 5 != $cyber_dc_boot_theme_options['layout'] )
				get_sidebar();
			get_sidebar( 'second' );
		}
		?>
	...
	<div id="footer-content" class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<span class="credit-link pull-right"><?php printf( __( '%s created by %s.', 'cdc_lobster' ), CYBER_DC_LOBSTER, '<a href="http://cyberdesigncraft.com/lobster/">Cyberdesign Craft</a>' ); ?></span>
			</div><!-- .col-lg-12 -->
		</div><!-- .row -->
