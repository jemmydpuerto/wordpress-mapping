...
<body <?php body_class( 'basic' ); ?>>
	<?php 	//echo'<pre>';
			//var_dump(cyber_dc_boot_theme_options());
			//echo '</pre>';
...
<?php
			cyber_dc_boot_jumbotron();
			cyber_dc_boot_home_page_default_widgets(); ?>
		...
		<div id="main">
			...
			post/page templates */
			if ( is_cyber_dc_boot_full_width() && 5 == $cyber_dc_boot_theme_options['layout'] )
				get_sidebar();